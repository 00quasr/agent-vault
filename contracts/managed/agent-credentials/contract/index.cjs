...
class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      issueCredential: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(agentSecret_0),
      ...
      proveAuthorization: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`proveAuthorization: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const agentSecret_0 = args_1[1];
        const expectedCommitment_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('proveAuthorization',
                                      'argument 1 (as invoked from Typescript)',
                                      'agent-credentials.compact line 31 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
        const context = { ...contextOrig_0 };
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(agentSecret_0).concat(_descriptor_1.toValue(expectedCommitment_0)),
        ...
        const result_0 = this._proveAuthorization_0(context,
                                                    partialProofData,
                                                    agentSecret_0,
      ...
      reportBlocked: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`reportBlocked: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('reportBlocked',
                                      'argument 1 (as invoked from Typescript)',
                                      'agent-credentials.compact line 45 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
        const context = { ...contextOrig_0 };
        ...
        const result_0 = this._reportBlocked_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData };
      }
    };
    this.impureCircuits = {
      ...
      reportBlocked: this.circuits.reportBlocked
    };
  }
  initialState(...args_0) {
    if (args_0.length !== 1) {
    ...
    state_0.setOperation('reportBlocked', new __compactRuntime.ContractOperation());
    const context = {
  ...
  _issueCredential_0(context, partialProofData, agentSecret_0) {
    Contract._query(context,
                    partialProofData,
                    [
                     { push: { storage: false,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_6.toValue(3n),
                                                                            alignment: _descriptor_6.alignment() }).encode() } },
                     { push: { storage: true,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(agentSecret_0),
                                                                            alignment: _descriptor_1.alignment() }).encode() } },
                     { ins: { cached: false, n: 1 } }]);
    const tmp_0 = 1n;
    Contract._query(context,
  ...
  _proveAuthorization_0(context,
                        partialProofData,
                        agentSecret_0,
                        expectedCommitment_0)
  {
    __compactRuntime.assert(agentSecret_0 === expectedCommitment_0,
                            'Invalid credential');
    const tmp_0 = 1n;
    Contract._query(context,
                    partialProofData,
  ...
  _reportBlocked_0(context, partialProofData) {
    const tmp_0 = 1n;
    Contract._query(context,
                    partialProofData,
                    [
